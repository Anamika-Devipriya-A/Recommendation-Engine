...
def genre(g_name):
        ...
        return build_chart(g_name).head(4)

#output: best 4 in each genre   

#combination of content based and collaborative algo recommender

def final_recom(search):
        md = pd.read_csv('/archive/movies_metadata.csv')
        md.head()
